...
const Updaterow = ()=>{
    ...
    fetch(`https://sheetdb.io/api/v1/f2ewkhwrqu3lw/id/${rid}`, {
        method: 'PATCH',
        headers: {
  ...
  return (
    <div>
      <button className='button-Update' id='upbut' onClick={()=>{Updaterow();} }>Update Bottom</button>
